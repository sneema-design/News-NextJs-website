...
export default function Page() {
  ...
  const { data, isPending, isError } = useGetNewsByTitle(decodedTitle);
  ...
  if (isError || !data || !data.articles?.length)
    return (
      <p className="text-center mt-10 text-red-500">Failed to load article</p>
    );
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div
          className="text-xl leading-relaxed font-serif text-gray-900
